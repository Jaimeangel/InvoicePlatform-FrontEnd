  ...
  return (
    <div className="w-full  bg-white rounded-lg px-10 py-6 shadow flex flex-row justify-between">
        ...
        <button
            ...
            className='flex flex-row justify-center items-center gap-2 text-black text-lg tracking-wide font-semibold py-3 rounded-xl hover:bg-slate-100 shadow border px-8'
        >   
